...
<body>
	...
	%>
			...
			String ex_object1 = URLDecoder.decode(request.getParameter("ex_object1"),"utf-8");
				...
				ArrayList<String> list = db.getObject2(ex_object1);
			%>
			<%= ex_object1 %>
    <!-- Form Start -->
        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="../exam/examMain3.jsp" name="examForm" method="post">
                    	<input type="hidden" name="mem_id" value="<%= mem_id %>">
                    	<input type="hidden" value="<%= URLEncoder.encode(ex_object1,"utf-8") %>" name="ex_object1">
                    		<div class="form-floating mb-3">
                    			<select class="form-select" id="floatingSelect" name="ex_object2"
