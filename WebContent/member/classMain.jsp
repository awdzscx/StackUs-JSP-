...
<head>
    ...
    $(function(){
		$(".pop_btn").click(function(){
			...
			window.open("../exam/examMain.jsp","기출문제 풀기","width=880px, height = 550px");
		});
		$(".pop_question").click(function(){
			var popUrl = "../teacher/questionWrite.jsp";
			var popOption = "width=650px, height = 550px, resizable= no, location=no,top=300px,left=300px";
			window.open("../member/questionSolve.jsp","클래스 문제 풀기","width=800px, height = 1000px");
		});
		/* 학생관리 */
...
%>
                    ...
                    <div class="col-sm-12">
						...
						<img class="rounded-circle" src="../images/<%= tea_image %>" width="90px" height="90px">
							<div style="margin-left: 10px">
                                <p class="mb-2">환영합니다.<b><%=cla_name %></b>입니다.</p>
                                <h6 class="mb-0"><%= bean.getCla_intro() %></h6>
                                <h6 class="mb-0"><%= tea_id %>선생님의 클래스</h6>
                            </div>
                            &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                            &emsp;&emsp;&emsp;&emsp;
                            <input type="button" class="btn btn-primary m-2 pop_question" value="문제풀러가기">
                            <!-- 학생관리 -->
                            <% if(type.equals("Teacher")){
                            	%>
                            <input type="button" class="btn btn-primary m-2 pop_manage" value="학생관리">   
							<%}else{
								}
								%>
                            <!-- 학생관리 -->    
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="h-100 bg-light rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h6 class="mb-0"><i class="bi bi-award" style="font-size: 1.5rem; color: #389dff;"></i>&nbsp;오답률높은문제</h6>
                            </div>
	<%
	...
	%>
                            <div class="d-flex align-items-center border-bottom py-3">
                                ...
                                <div class="w-100 ms-3">
                                    ...
                                    <h6 class="mb-0"><%= qbean.getQ_no() %>번문제</h6>
                                        <small>정답률 : <%= qbean.getPercent() %>%</small>
                                    </div>
    ...
    %>
						...
						<div class="" style="width:100%; background-color: #f3f6f9; padding: 10px">
							<div class="">
								<div class="">
									<div class="">
										<div class="">
											<h4 style="color: #389dff"><i class="" style=""></i><%=cla_name%> 채팅방</h4>
										</div>
										<div class=""></div>
									</div>
									<div id="chat" class="">
										...
										<div class="">
											...
											<div class="" style="height:80px">
												<div class=" ">
													<input type="text" onkeyup="enterkey();" style="height:60px;" id="chatContent" class="form-control" placeholder="메시지를 입력하세요" maxlength="100"></textarea>
												</div> 
											</div>
											<div class="">
            ...
            <input type="button" name="exitbtn" value="클래스 탈퇴" class="btn btn-dark" onclick="removeCheck()">
            </div>
            <% }else{
            	}%>
