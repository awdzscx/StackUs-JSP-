...
<body>
	...
	<%
		if(session.getAttribute("id")!= null){
			...
			ArrayList<classBean> list = cdb.searchClass(search);
			if(list.size()!= 0){
            ...
            <!-- Sale & Revenue Start -->
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                          ...
                          <img onclick="location.href='classMain.jsp?cla_name=<%= URLEncoder.encode(bean.getCla_name(),"utf-8") %>&tea_id=<%=tea_id%>'" alt="tea_image" src="../images/<%=tea_image%>" width="90px" height="90px">
