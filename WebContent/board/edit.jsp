...
<%
	...
	if(request.getParameter("bo_type") != null){
		bo_type = request.getParameter("bo_type");
	}
				...
				<div class="row g-4">
					<div class="col-sm-12">
                        <div class="bg-light rounded h-100 p-4">
                        	<h4 class="mb-4">
                        	<form action="../board/edit_ok.jsp" name="reg_frm" method="post">
                    		<input type="hidden" name="mem_id" value="<%=mem_id%>">
							<input type="hidden" name="mem_no" value="<%=mem_no%>">
							<input type="hidden" name="bo_no" value="<%=bo_no%>">
							<input type="hidden" name="bo_type" value="<%=bo_type%>">
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" class="form-control" name="bo_title" maxlength="8" value="<%= board.getBo_title() %>">
                            </div>
                            ...
                            <br>
                            <div align="right">
                            	<input class="btn btn-outline-secondary" type="button" value="수정" onclick="check_ok()">&nbsp;
								<input class="btn btn-outline-secondary" type="reset" value="다시작성">&nbsp;
								<input class="btn btn-outline-secondary" type="button" value="글목록" onclick="javascript:window.location='../board/boardlist_<%= bo_type %>.jsp'">
                            </div>
                            </form>
                        </div>
                    </div>
