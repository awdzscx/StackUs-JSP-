...
<%
	...
	ArrayList<BoardBean> boardList = db.listBoard(pageNum, 0, sq); // listBoard() 메소드 호출하여 값 가져오기
	Timestamp bo_date;
			...
			<div class="container-fluid pt-4 px-4">
				<div class="row g-4">
                            ...
                            <table class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <%if(sq==0){%><th scope="col" style="width: 10%" class="text-center"><a href="../board/boardlist_0.jsp?sq=<%=1%>">추천수</a></th><%}%>
                                        <%if(sq==1){%><th scope="col" style="width: 10%" class="text-center"><a href="../board/boardlist_0.jsp?sq=<%=0%>">추천수</a></th><%}%>
					...
					%>
                            ...
                            <div align="right">
                            	<%if(session.getAttribute("id").equals("admin")){%><button class="btn btn-outline-secondary" onclick="location.href='../board/write.jsp?bo_type=0'">글쓰기</button><%}%>
							</div>
							<div align="center">
								<%= BoardBean.pageNumber(5,"0") %>
							</div>
                        </div>
                    </div>
				</div>
