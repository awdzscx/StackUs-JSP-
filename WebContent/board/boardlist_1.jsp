...
<%
	...
	ArrayList<BoardBean> boardList = db.listBoard(pageNum, 1, sq); // listBoard() 메소드 호출하여 값 가져오기
	Timestamp bo_date;
	int bo_no, bo_hit, mem_no;
	String bo_content, bo_title, mem_id, bo_type;
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="../board/boardlist_1.jsp" class="dropdown-item active">자유게시판</a>
			...
			<div class="container-fluid pt-4 px-4">
				<div class="row g-4">
                            ...
                            <table class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <%if(sq==0){%><th scope="col" style="width: 10%" class="text-center"><a href="../board/boardlist_1.jsp?sq=<%=1%>">추천수</a></th><%}%>
                                        <%if(sq==1){%><th scope="col" style="width: 10%" class="text-center"><a href="../board/boardlist_1.jsp?sq=<%=0%>">추천수</a></th><%}%>
					...
					%>
                            ...
                            <div align="right">
                            	<button class="btn btn-outline-secondary" onclick="location.href='../board/write.jsp?bo_type=1'">글쓰기</button>
							</div>
							<div align="center">
								<%= BoardBean.pageNumber(5,"1") %>
							</div>
                        </div>
                    </div>
				</div>
