...
<%
	...
	ArrayList<BoardBean> boardList = db.listBoard_search(pageNum, sq, search); // listBoard() 메소드 호출하여 값 가져오기
	Timestamp bo_date;
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="../board/boardlist_3.jsp" class="dropdown-item active">QnA</a>
                        </div>
                    </div>
					<%
                    	if(mem_type== 3){
				...
				<div class="row g-4">
					<div class="col-sm-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h4 class="mb-4">검 색</h4>
                            <table class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        <th scope="col" class="text-center" style="width: 10%">번호</th>
                                        <th scope="col" style="width: 40%" class="text-center">글제목</th>
                                        <%if(sq==0){%><th scope="col" style="width: 10%" class="text-center"><a href="../board/boardlist_search.jsp?sq=<%=1%>">추천수</a></th><%}%>
                                        <%if(sq==1){%><th scope="col" style="width: 10%" class="text-center"><a href="../board/boardlist_search.jsp?sq=<%=0%>">추천수</a></th><%}%>
                    ...
                    <%
						for(int i=0; i<boardList.size(); i++){
							...
							int bo_type = board.getBo_type();
					%>
                                    <tr onclick="location.href='show.jsp?bo_no=<%= bo_no %>&s_nom<%="search"%>'">
					...
					%>
                            ...
                            <div align="right">
                            	<button class="btn btn-outline-secondary" onclick="location.href='../board/write.jsp?bo_type=3'">글쓰기</button>
							</div>
							<div align="center">
								<%= BoardBean.pageNumber(5,"search") %>
							</div>
                        </div>
                    </div>
				</div>
