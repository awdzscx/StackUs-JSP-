...
<%
	...
	ArrayList<BoardBean> boardList = db.listBoard(pageNum, 3, sq); // listBoard() 메소드 호출하여 값 가져오기
	Timestamp bo_date;
                            ...
                            <table class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <%if(sq==0){%><th scope="col" style="width: 10%" class="text-center"><a href="../board/boardlist_3.jsp?sq=<%=1%>">추천수</a></th><%}%>
                                        <%if(sq==1){%><th scope="col" style="width: 10%" class="text-center"><a href="../board/boardlist_3.jsp?sq=<%=0%>">추천수</a></th><%}%>
