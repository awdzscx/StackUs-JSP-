                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-md-6" style="width: 100%;">
                        <div class="h-100 bg-light rounded p-4">
							  ...
							  <div class="container-fluid">
							    <div class="collapse navbar-collapse" id="navbarNav">
							      <ul class="navbar-nav">
							        ...
							        <li class="nav-item">
							          <a class="nav-link" href="../about/aboutT1.jsp">Teacher</a>
							        </li>
							      </ul>
							    </div>
							  </div>
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light bg-light">
							  <div class="container-fluid">
							    <div class="collapse navbar-collapse" id="navbarNav">
							      <ul class="navbar-nav">
							        <li class="nav-item">
							          <a class="nav-link" aria-current="page" href="../about/aboutS1.jsp">CBT 사용법</a>
							        </li>
							        <li class="nav-item">
							          <a class="nav-link active" href="../about/aboutS2.jsp">Class 사용법</a>
							        </li>
							      </ul>
							    </div>
							  </div>
                            ...
                            <div>
                            <img alt="표시할 수 없습니다" src="../images/aboutS4.png" style="width: 50%; height: 60%;">
                            <p style="display: inline-block; margin-left: 5%; margin-top: 5%;">로그인 후 Class 메뉴를 선택하면<br>원하는 교사가 개설한 Class에 가입할 수 있습니다.</p>
                            </div>
                            <div style="margin-top: 10%;">
                            <img alt="표시할 수 없습니다" src="../images/aboutS5.JPG" style="width: 50%; height: 60%;">
                            <p style="display: inline-block; margin-left: 5%; margin-top: 5%;">Class 메뉴에서는 강사가 직접 업로드한 문제를 풀거나,</p>
                            </div>
                            <div style="margin-top: 10%;">
                            <img alt="표시할 수 없습니다" src="../images/aboutS6.JPG" style="width: 40%; height: 45%;">
                            <p style="display: inline-block; margin-left: 5%;">같은 Class의 회원들과 실시간 채팅이 가능합니다.</p>
                            </div>
                            </div>
                            <!--  -->
                        </div>
