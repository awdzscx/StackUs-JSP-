                    ...
                    <div class="col-sm-12 col-md-6" style="width: 100%;">
                        <div class="h-100 bg-light rounded p-4">
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light bg-light">
							  <div class="container-fluid">
							    <div class="collapse navbar-collapse" id="navbarNav">
							      <ul class="navbar-nav">
							        <li class="nav-item">
							          <a class="nav-link active"href="#">Class 관리</a>
							        </li>
							        <li class="nav-item">
							          <a class="nav-link" aria-current="page"  href="../about/aboutT2.jsp">문제 업로드</a>
							        </li>
							      </ul>
							    </div>
							  </div>
                            ...
                            <!-- 내용  -->
                            	...
                            	<div>
	                            <img alt="표시할 수 없습니다" src="../images/aboutS8.png" style="width: 55%; height: 60%;">
	                            <p style="display: inline-block; margin-left: 5%; margin-top: 5%;">교수자 회원들은 Class를 개설할 수 있습니다.</p>
	                            </div>
                            	<div>
	                            <img alt="표시할 수 없습니다" src="../images/aboutS8.JPG" style="width: 40%; height: 45%; margin-top: 5%;">
	                            <p style="display: inline-block; margin-left: 5%; margin-top: 5%;">Class 이름과 설명, 과목을 설정해주세요.</p>
	                            </div>
                            	<div>
	                            <img alt="표시할 수 없습니다" src="../images/aboutS7.png" style="width: 60%; height: 65%; margin-top: 8%;">
	                            <p style="display: inline-block; margin-left: 5%; margin-top: 5%; margin-bottom: 2%;">Class에 가입한 학생들을 관리할 수 있습니다.</p>
	                            </div>
                            	<div>
	                            <img alt="표시할 수 없습니다" src="../images/aboutS7.JPG" style="width: 40%; height: 45%; margin-top: 5%;">
	                            <p style="display: inline-block; margin-left: 5%; margin-bottom: 5%; margin-top: 3%;">문제를 많이 푼 학생들을 포인트로 확인할 수 있고,<br>강퇴 버튼으로 회원을 Class에서 퇴출시킬 수 있습니다.</p>
	                            </div>
	                            </div>
                            <!--  -->
                        </div>
