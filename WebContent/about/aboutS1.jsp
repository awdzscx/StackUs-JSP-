                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-md-6" style="width: 100%;">
                        <div class="h-100 bg-light rounded p-4">
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light bg-light">
							  <div class="container-fluid">
							    <div class="collapse navbar-collapse" id="navbarNav">
							      <ul class="navbar-nav">
							        <li class="nav-item">
							          <a class="nav-link active" aria-current="page" href="#">CBT 사용법</a>
							        </li>
							        <li class="nav-item">
							          <a class="nav-link" href="../about/aboutS2.jsp">Class 사용법</a>
							        </li>
							      </ul>
							    </div>
							  </div>
                            ...
                            <div>
                            <img alt="표시할 수 없습니다" src="../images/aboutS1.png">
                            <p style="display: inline-block; margin-left: 5%;">로그인 후 CBT 메뉴를 선택하면<br>년도별 자격증 모의고사 시험을 칠 수 있습니다.</p>
                            </div>
                            <div style="margin-top: 5%;">
                            <img alt="표시할 수 없습니다" src="../images/aboutS2.JPG" width="60%;" height="65%;">
                            <p style="display: inline-block;">원하는 과목 이름, 시험 연도,<br>회차를 정확히 입력해주세요.</p>
                            </div>
                            <div style="margin-top: 8%;">
                            <img alt="표시할 수 없습니다" src="../images/aboutS3.JPG" width="40%;" height="45%;">
                            <p style="display: inline-block; margin-bottom: 10%; margin-left: 5%;">모의고사를 끝까지 풀면 점수가 저장되고,<br>오답과 해설을 확인할 수 있습니다.</p>
                            </div>
                            </div>
                            <!--  -->
                        </div>
