...
<body>
	...
	<form action="questionWriteOk.jsp" name="questionForm" method="post" enctype="multipart/form-data">
       	<div class="mb-3">
           <label for="formFile" class="form-label">문제 입력(이미지)</label>
           <input type="file" class="form-control" name="q_fname" id="formFile">
        </div>
		<input class="btn btn-outline-primary m-2" type="button" onclick="location.href='questionWriteOk.jsp?q_fname=pass'" value="이미지건너뛰기">
		<input class="btn btn-outline-primary m-2" type="submit" value="입력하기">
		<input class="btn btn-outline-primary m-2" type="reset" value="다시쓰기">
	</form>
	</div></div></div>
	</center>
	    <!-- Form End -->
